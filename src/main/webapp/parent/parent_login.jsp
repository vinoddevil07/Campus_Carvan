...
<body>
	...
	<div class="container-fluid">
		...
		<h2 class="text-danger" style="text-align: center;">Parent Login Form</h2>
	...
	<div class="row" style="">
		...
		<div class="col-4  " style="margin-top: 3%">
			...
			<form method="post" action="/CampusCarvan/Parent_login" novalidate
				...
				<div class="text-center">
					<p>
						Not a member? <a href="/CampusCarvan/parent/parent_registration.jsp">Register</a>
					</p>
				</div>
