...
<div class="row" style="margin-bottom: 10%;margin: 5%;margin-left: 5%">
    ...
    <div class="col-3">
        ...
        <button type="button" class="btn btn-dark w-100 mt-2">
            <a style="color: white; text-decoration: none;" href="/CampusCarvan/school/view_vehicles.jsp"><strong>Booking</strong></a>
        </button>
    </div>
    ...
    <div class="col-3">
        ...
        <button type="button" class="btn btn-dark w-100 mt-2">
            <a style="color: white; text-decoration: none;" href="/CampusCarvan/school/view_confirm_booking.jsp"><strong>Confired Booking</strong></a>
        </button>
    </div>
