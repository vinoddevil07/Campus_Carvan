...
<%-- <h1>Hello <%=parent_id%> You are <%=role%></h1>
</div> --%>
									...
									<div class="card-body p-4">
										...
										<div class="row pt-1">
											<div class="col-6 mb-3">
												<h6>Email</h6>
												<p class="text-muted"><%=s.getEmail()%></p>
											</div>
											<div class="col-6 mb-3">
												<h6>Phone</h6>
												<p class="text-muted"><%=s.getPhone()%></p>
											</div>
											<div class="col-6 mb-3">
												<h6>Address</h6>
												<p class="text-muted"><%=s.getAddress()%></p>
											</div>
										</div>
